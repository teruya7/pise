...
def write_primitivecell_info(markdown, summary_info):
    ...
    markdown.write("| ---- | ---- |\n")
    markdown.write(f'|  a (Ang.) |  {summary_info["POSCAR"]["a"]} |\n')
    markdown.write(f'|  b (Ang.) |  {summary_info["POSCAR"]["b"]} |\n')
    markdown.write(f'|  c (Ang.) |  {summary_info["POSCAR"]["c"]} |\n')
    markdown.write(f'|  alpha |  {summary_info["POSCAR"]["alpha"]} |\n')
    markdown.write(f'|  beta |  {summary_info["POSCAR"]["beta"]} |\n')
    markdown.write(f'|  gamma |  {summary_info["POSCAR"]["gamma"]} |\n')
    markdown.write(f'|  n_atoms  |  {summary_info["POSCAR"]["n_atoms"]}  |\n')
    markdown.write(f'|  space group  |  {summary_info["space group"]}  |\n')
...
def write_hydrogen_atom_model_info(markdown, summary_info):
    ...
    markdown.write("|    |    |\n")
    markdown.write("| ---- | ---- |\n")
    markdown.write(f'|  donor (meV) |  {donor} |\n')
    markdown.write(f'|  acceptor (meV) |  {acceptor} |\n')
    markdown.write('<div style="page-break-before:always"></div>\n\n')
...
def write_supercell_info(markdown, summary_info):
    ...
    markdown.write("|  supercell  |    |\n")
    markdown.write("| ---- | ---- |\n")
    markdown.write(f'|  a (Ang.) |  {summary_info["SPOSCAR"]["a"]} |\n')
    markdown.write(f'|  b (Ang.) |  {summary_info["SPOSCAR"]["b"]} |\n')
    markdown.write(f'|  c (Ang.) |  {summary_info["SPOSCAR"]["c"]} |\n')
